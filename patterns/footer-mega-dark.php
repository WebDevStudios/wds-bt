...
<figure class="wp-block-image aligncenter size-full is-resized"><a href="https://powderstudio.com/"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/site-logo-light.svg'; ?>" alt="Site Logo" class="wp-image-7" width="40" height="40"/></a></figure>
<!-- /wp:image -->
