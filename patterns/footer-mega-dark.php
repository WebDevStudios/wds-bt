 ...
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large","right":"30px","left":"30px"},"blockGap":"0px"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"contrast","textColor":"base","className":"is-style-pull-100","layout":{"type":"constrained"},"fontSize":"x-small"} -->
<div class="wp-block-group alignfull is-style-pull-100 has-base-color has-contrast-background-color has-text-color has-background has-link-color has-x-small-font-size" style="padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
...
<figure class="wp-block-image aligncenter size-full is-resized"><a href="https://powdermade.com/"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/site-logo-light.svg'; ?>" alt="Site Logo" class="wp-image-7" width="40" height="40"/></a></figure>
<!-- /wp:image -->
...
<!-- /wp:group -->
<!-- wp:group {"align":"wide","style":{"border":{"top":{"color":"#262626","width":"1px"},"bottom":{"color":"#262626","width":"1px"}},"spacing":{"padding":{"top":"var(--wp--preset--spacing--small)","bottom":"var(--wp--preset--spacing--small)"},"margin":{"top":"0px"}}}} -->
<div class="wp-block-group alignwide" style="border-top-color:#262626;border-top-width:1px;border-bottom-color:#262626;border-bottom-width:1px;margin-top:0px;padding-top:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small)">
...
<!-- wp:button {"backgroundColor":"base","textColor":"contrast","align":"center"} -->
<div class="wp-block-button aligncenter"><a class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background wp-element-button" href="#" target="_blank" rel="noreferrer noopener"><?php echo esc_html__( 'Call to Action', 'powder' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
