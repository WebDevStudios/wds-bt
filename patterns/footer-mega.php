...
<div class="wp-block-group alignfull has-x-small-font-size" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--medium)">
		...
		<!-- /wp:group -->
		<!-- wp:social-links {"iconColor":"contrast","iconColorValue":"#0a0a0a","size":"has-small-icon-size","style":{"layout":{"selfStretch":"fit","flexSize":null}},"className":"is-style-outline","layout":{"type":"flex","justifyContent":"right"}} -->
