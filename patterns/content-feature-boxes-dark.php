...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	<!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"lineHeight":"1"}},"fontSize":"max-48"} -->
	<h1 class="wp-block-heading has-text-align-center has-max-48-font-size" style="line-height:1"><?php echo esc_html__( 'Choose Powder.', 'powder' ); ?></h1>
	<!-- /wp:heading -->
	<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"10px","bottom":"var:preset|spacing|small"}}}} -->
	<p class="has-text-align-center" style="margin-top:10px;margin-bottom:var(--wp--preset--spacing--small)"><?php echo esc_html__( 'Redefine your space with a stylish, modern design.', 'powder' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column has-border-color" style="border-color:#262626;border-width:1px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--small)">
			...
			<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/icon-circle-bolt-light.svg'; ?>" alt="Circle check light icon" style="object-fit:cover;width:30px;height:30px" width="30" height="30"/></figure>
			<!-- /wp:image -->
